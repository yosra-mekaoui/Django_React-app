  ...
  return (
    <>
      <Container fluid="md">
        ...
        <button type="button" className="btn btn-outline-dark" onClick={handleOpenModal}>
          Ajouter une classe
        </button>
      </Container>
      ...
      <Container fluid="md">
        <Row>
          {classes.length !== 0 ? (
            classes.map((e) => <Classe key={e.id} Classe={e} delete={deleteB} handleEditClick={handleEditClick} />)
          ) : (
            <Col>
